...
EXPLORATION_BLOCK  = "950_6.5-10" # акт
...
data_assay = pd.DataFrame(data_assay)
data_strings = pd.DataFrame(data_strings)
...
try:
    ...
    logging.info(f"Формирование координат полигонов из {DATA_NAME_FILE_STRINGS}.")
